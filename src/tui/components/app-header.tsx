    ...
    <>
      <Box paddingY={1} flexDirection="column">
        <Text wrap="truncate-end">
          ...
          <Text color="white">epubdomain-downloader </Text>
          <Text color="green">@{APP_VERSION}</Text>
          <Text> {figures.arrowRight} </Text>
          <Text color="gray">github.com/VeigaPunk/epublicdomain</Text>
        </Text>
      ...
      {newVersionAvailable && (
        <Box>
          <Text>
            ...
            <Text color="blue"> run npm i -g epubdomain-downloader to update</Text>
          </Text>
        </Box>
      )}
    </>
